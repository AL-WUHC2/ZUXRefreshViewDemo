...
#define commentBounds   CGRectMake(0, 0, 140.f, 20.f)
...
- (void)zuxInitial {
    [super zuxInitial];
    self.direction = ZUXRefreshPullUp;
    
    _arrow = [[UIImageView alloc] init];
    _arrow.image = [UIImage imageNamed:@"LoadmoreArrow"];
    ...
    _commentNormal = [[UIImage imageNamed:@"LoadmoreCommentNormal"] retain];
    _commentPulling = [[UIImage imageNamed:@"LoadmoreCommentPulling"] retain];
    _commentLoading = [[UIImage imageNamed:@"LoadmoreCommentLoading"] retain];
...
- (void)layoutSubviews {
    ...
    _arrow.frame = CGRectMake((width-indicatorBounds.size.width-commentBounds.size.width)/2.,
                              (height-indicatorBounds.size.height)/2.,
    ...
    _comment.frame = CGRectMake((width-indicatorBounds.size.width-commentBounds.size.width)/2.+indicatorBounds.size.width,
                                (height-commentBounds.size.height)/2.,
